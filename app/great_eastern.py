...
from policy_data import ge_policies
...
@app.route("/great_eastern/category/<string:cat>")
def get_by_category(cat):
    try:
        ...
        return jsonify({
            "code": 500,
            "message": "great_eastern.py internal error: " + ex_str
        }), 500

# retrieve a policy, based on its policy_id
@app.route("/great_eastern/id/<string:policy_id>")
...
@app.route("/great_eastern/createpolicy/<string:policy_id>")
...
if __name__ == "__main__":  
    print("This is flask for " + os.path.basename(__file__) + ": retrieving Great Eastern policies...")
